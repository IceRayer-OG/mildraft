...
// Queries
import { postPlayerToQueue, deletePlayerFromQueue, getMyQueuePlayers, updateQueueOrder } from "../database/queueQueries";
...
export async function updateMyQueueOrderUseCase(queueOrder: {playerId: number, rank: number}[]) {
